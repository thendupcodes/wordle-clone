	...
	const [barHeights, barValues]: [number[], number[]] = useMemo(() => {
		...
		return [
			[g1, g2, g3, g4, g5, g6].map((g) =>
				Math.max(Math.floor((g / most) * barMaxHeight), 2)
			),
			[g1, g2, g3, g4, g5, g6],
		];
	}, [guessDistribution]);
		...
		return (
			<div className="Stats">
				...
				<div className="Stats__body Stats__body--no-stats">
					...
					<p>
						Finish today's wordle and your stats will be revealed at the end of
						the challenge.
					</p>
					<p>Happy guessing!</p>
				</div>
			...
			<div className="Stats__body">
				...
				<div className="Stats__body-items">
					<div className="Stats__body-item">
						<div className="Stats__body-item-value">{games}</div>

						<div className="Stats__body-item-key">Played</div>
					</div>

					<div className="Stats__body-item">
						<div className="Stats__body-item-value">{wins}</div>

						<div className="Stats__body-item-key">Won</div>
					</div>
